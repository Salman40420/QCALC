...
public class StandardCalculatorTest {
    ...
    void testMultiplicationOpeartionForDoubles() {
        standardCalculator.multiply(12.0, 8.0);
        double actualResult = standardCalculator.getResult();
        Assertions.assertEquals(96.0, actualResult);
    }

    @Test
    @DisplayName("Test Division of Two Doubles")
    void testDivisionOpeartionForDoubles() {
        standardCalculator.divide(12.0, 8.0);
        double actualResult = standardCalculator.getResult();
    ...
    void testMultiplicationOpeartion() {
    ...
    void testDivisionByZeroOpeartion() {
